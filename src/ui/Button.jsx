...
function Button({ children, onClick, type, to, name: pageName, customeStyle, disabled = false }) {
  ...
  const styles = {
    ...
    primary: `flex items-center justify-center gap-2 bg-blue-700 transition-all duration-300 border border-transparent text-white
     ...
     secondary: `inline-flex justify-center items-center gap-2 transition-all duration-300 p-2 border-white border-2 text-sm font-bold rounded-md
                text-blue-600 bg-white hover:bg-transparent hover:text-white hover:border-white focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-blue-600`,
